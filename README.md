...
See that there is a conversion from addition to multiplication which may lead up to the [11th-dimension](https://www.techtarget.com/whatis/definition/11th-dimension) of string theory. This distribution is used as our project structure as you can see on the left sidebar. (Please change to desktop view if you are on mobile device).

Nothing is going to be easy about the nature of prime numbers but they demonstrably congruent to something organized. Let's discuss starting with the _[addition zones](https://www.eq19.com/addition/)_.
